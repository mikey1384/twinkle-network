    ...
    showHelperMessageTimerRef.current = setTimeout(() => {
      setUrlHelper(
        urlIsValid || stringIsEmpty(url)
          ? ''
          : `Enter a URL. A URL is the address of a website. Twinkle Network's URL is <a href="https://www.twin-kle.com" target="_blank">www.twin-kle.com</a> and <a href="https://www.twinkle.network" target="_blank">www.twinkle.network</a>. You can find a webpage's URL at the <b>top area of your browser</b>. Copy a URL you want to share and paste it to the box above.`
      );
