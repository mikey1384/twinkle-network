...
# Database: twinkle
# Generation Time: 2017-05-16 01:11:33 +0000
# ************************************************************
...
VALUES
	...
	(1184,5,'video',86,'hello man',1494765865,1182,1183,NULL),
...
VALUES
	...
	(51,'React router!! ?  ','<a href=\"http://www.naver.com\" target=\"_blank\">www.naver.com</a> <br>yaA!<br>hoy ? ',3,'https://github.com/ReactTraining/react-router',5,1487344491),
	(52,'cool bootstrap trick','',3,'http://jsfiddle.net/jayjin/8bxYr/584/',5,1493545446);
...
VALUES
	...
	(2904,758,5,'hello',1487758378,0,0),
	(3025,831,5,'hi',1492498282,0,0),
	(3031,2,205,'Hello World',1492872611,0,0),
	(3032,2,5,'hi',1494399078,0,0),
	(3033,243,5,'yo',1494399083,0,0),
	(3034,752,205,'Created channel \"codefights\"',1494491692,1,0),
	(3036,753,205,'Created channel \"hello world\"',1494491737,1,0);
...
VALUES
	...
	(15,'url',20,'url',20,NULL,NULL,5,1476433709),
	(16,'url',21,'url',21,NULL,NULL,5,1476433735),
	(17,'video',15,'video',15,NULL,NULL,228,1476449749),
	(18,'video',16,'video',16,NULL,NULL,5,1476450729),
	(19,'url',22,'url',22,NULL,NULL,5,1476705232),
	...
	(192,'video',62,'video',62,NULL,NULL,5,1481975952),
	...
	(552,'url',48,'url',48,NULL,NULL,5,1487167035),
	...
	(761,'video',84,'video',84,NULL,NULL,5,1493089561),
...
VALUES
	...
	(232,'dave','Dave Chung',NULL,NULL,'user',1488357026,'sha1$af6c118d$1$a0c8a590267a69110c615d0a80a31e0a34c8543c',822,NULL,NULL,NULL),
	(233,'newsignupdone','Fdas Fdsa',NULL,'',NULL,1493049797,'sha1$bc341034$1$47318cbf4c62621682da411499179ad1ab21e937',NULL,NULL,NULL,NULL);
...
VALUES
	...
	(3,'The Zen Master ? ','fds<br>?  ?  <br>fdsafsa',NULL,'TquQe7Id9-4',5,NULL),
	...
	(77,'Flexbox','',3,'JJSoEo8JSnc',5,1487640338),
	(78,'짱구','',7,'obfwuo7ymc0',5,1489412749),
	(79,'Sam Altman\'s Top 10 Rules For Success','',3,'iRLyLQos6FQ',5,1491818260),
	(82,'Live Office Hours with Yuri Sagalov and Sam Altman',':)',7,'abtHadERzXU',5,1492477963),
	(83,'South Park',':)',2,'ZrU_tt4R3xY',5,1493012113),
	(84,'Nintendo Switch Explained ?','Wow ?  ? ',6,'2cJaWWugyzE',5,1493089561),
	(85,'Opening scene of the social network','',1,'IlXwTxpC6u0',5,1493357115),
	(86,'HYPE AS F**K - Hyper Dragon Ball Z: Goku Arcade Mode','',5,'xC5FcIh4-Y4',205,1494763058);
