        ...
        <Modal.Body>
          ...
          { selectTabActive &&
            <div>
              <CheckListGroup
                ...
                listItems={
                  playlistsToPin.map(playlist => {
                    let checked = false;
                    if (selectedPlaylists.indexOf(playlist.id) !== -1) {
                      checked = true;
                    }
                    return {
              ...
              {
                playlistsToPin.length === 0 && <div className="text-center">No Playlists</div>
              }
            </div>
          }
          { !selectTabActive &&
            <div>
              ...
              />
              {
                selectedPlaylists.length === 0 && <div className="text-center">No Playlist Selected</div>
              }
            </div>
          }
          </div>
